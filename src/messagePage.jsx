...
class MessagePage extends React.Component
{
	constructor()
	{
		...
		this.socket = io("http://php-empty-site-p7x3h7.azurewebsites.net:8000");
	...
	loadConversation(index)
	{
		...
		xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/getConversationData.php?arg1=" + localStorage.getItem("userID") + "&arg2=" + index);
		xhttp.send();
	}
	...
	getNumConversations(cb)
	{
		...
		xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/getNumConversations.php?arg1=" + localStorage.getItem("userID"));
		xhttp.send();
	}
	...
	getNumMessages(cb)
	{
		...
		xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/getNumMessages.php?user1=" + localStorage.getItem("userID") + "&user2=" + this.state.messages.user);
		xhttp.send();
	}
	...
	loadMessage(index)
	{
		...
		xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/getMessageData.php?user1=" + localStorage.getItem("userID") + "&user2=" + this.state.messages.user + "&index=" + index);
		xhttp.send();
	}
	...
	sendMessage(text)
	{
		...
		else
		{
			...
			xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/addMessage.php?message=" + text + "&sender=" + localStorage.getItem("userID") + "&receiver=" + this.state.messages.user);
			xhttp.send();
		}
	}
