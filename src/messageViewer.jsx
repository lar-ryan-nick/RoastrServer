				...
				<div style={{height:"100%"}}>
					<div style={{backgroundColor:"#fefeff", height:"10%"}}>
						<center>
							...
							<a href={"http://php-empty-site-p7x3h7.azurewebsites.net/profile.html?user=" + this.props.data.user} style={{paddingLeft:10, margin:0, textDecoration:"none", verticalAlign:"top", display:"inline-block", fontSize:"2em", color:"#000000"}}>{this.props.data.username}</a>
						</center>
					</div>
					<div ref={(input) => {this.messages = input;}} onScroll={this.handleScroll} style={{height:"85%", overflowY:"auto", backgroundColor:"#2d3142"}}>
						{messages}
