...
{
	window.location = "http://php-empty-site-p7x3h7.azurewebsites.net/post.html";
}
...
function loadPost(arg1, arg2, cb)
{
	...
	xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/getPostData.php?arg1=" + arg1 + "&arg2=" + arg2 + "&arg3=" + localStorage.getItem("userID"), true);
	xhttp.timeout = 0;
	xhttp.send();
}
...
function hatePost(postID)
{
	...
	xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/addLike.php?user=" + localStorage.getItem("userID") + "&post=" + postID, true);
	xhttp.send();
}
function unhatePost(postID)
{
	...
	xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/removeLike.php?user=" + localStorage.getItem("userID") + "&post=" + postID, true);
	xhttp.send();
}
function getNumHates(postID)
{
	...
	xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/getNumLikes.php?arg1=" + postID, true);
	xhttp.send();
}
function loadComment(postID, index, cb)
{
	var xhttp = new XMLHttpRequest();
	//console.log("http://php-empty-site-p7x3h7.azurewebsites.net/getCommentData.php?arg1=" + postID + "&arg2=" + index);
	xhttp.onreadystatechange = function()
	{
		if (this.readyState == 4 && this.status == 200)
		{
	...
	xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/getCommentData.php?arg1=" + postID + "&arg2=" + index);
	xhttp.send();
}
...
function getNumComments(postID, cb)
{
	...
	xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/getNumComments.php?arg1=" + postID, true);
	xhttp.send();
}
function addComment(postID, comment, cb)
{
	...
	//console.log(comment);
	xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/addComment.php?comment=\"" + comment + "\"&post=" + postID + "&user=" + localStorage.getItem("userID"));
	xhttp.send();
}
function getUserData(cb)
{
	...
	//console.log(comment);
	xhttp.open("GET", "http://php-empty-site-p7x3h7.azurewebsites.net/getUserData.php?&arg1=" + localStorage.getItem("userID") + "&arg2=" + localStorage.getItem("userID"));
	xhttp.send();
}
